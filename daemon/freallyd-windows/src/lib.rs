//! `freallyd-windows` library surface (Phase 12 scaffold + Phase 8 Wave 2 plumbing).
//!
...
//! (TASK-240) so `cargo build --workspace` produces a `freallyd` binary
