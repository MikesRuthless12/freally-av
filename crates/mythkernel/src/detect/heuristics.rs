...
//!
//!   * Linux — `daemon/mythd-linux/src/fanotify.rs` event loop
//!   * macOS — `daemon/mythd-macos/src/esf_failover.rs` post-dedupe drain
...
pub const RULE_SOURCE: &str = "mythodikal_heuristics";
