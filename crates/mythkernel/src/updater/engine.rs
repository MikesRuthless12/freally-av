...
//! `latest.json` from `https://github.com/MikesRuthless12/mythodikal-av/releases/latest/download/`
...
//! Updater plugin in the Tauri shell (see `apps/mythodikal/src-tauri/src/lib.rs`);
...
pub const DEFAULT_LATEST_JSON_URL: &str =
    "https://github.com/MikesRuthless12/mythodikal-av/releases/latest/download/latest.json";
...
impl EngineChannel {
    ...
    pub async fn check_for_updates(
        ...
        let client = reqwest::Client::builder()
            ...
            .user_agent(format!(
                "Mythodikal-AV/{} (+https://github.com/MikesRuthless12/mythodikal-av)",
        ...
        Ok(Some(EngineUpdateAvailable {
            ...
            release_url: format!(
                "https://github.com/MikesRuthless12/mythodikal-av/releases/tag/v{tag_version}"
            ),
...
mod tests {
    ...
    fn verify_signature_rejects_garbage_signature() {
        // Real Mythodikal pubkey from `scripts/gen-signing-key/` — but
