...
//!
//! The transport is a Unix-domain socket at `/run/mythd/mythd.sock`
//! when run with systemd-level privileges, or `<XDG_RUNTIME_DIR>/mythd.sock`
...
pub const SYSTEM_SOCKET_PATH: &str = "/run/mythd/mythd.sock";
