...
pub const MYTHODIKAL_INOTIFY_MASK: u32 = IN_MODIFY
    | IN_ATTRIB
    | IN_CLOSE_WRITE
    | IN_MOVED_FROM
    | IN_MOVED_TO
...
pub const MYTHODIKAL_FANOTIFY_MASK: u64 = FAN_MODIFY
    | FAN_ATTRIB
    | FAN_CLOSE_WRITE
    | FAN_MOVED_FROM
    | FAN_MOVED_TO
...
mod tests {
    ...
    #[test]
    fn mythodikal_mask_excludes_read_only_chatter() {
        assert_eq!(MYTHODIKAL_INOTIFY_MASK & IN_ACCESS, 0);
        assert_eq!(MYTHODIKAL_INOTIFY_MASK & IN_OPEN, 0);
        assert_eq!(MYTHODIKAL_INOTIFY_MASK & IN_CLOSE_NOWRITE, 0);
        assert_eq!(MYTHODIKAL_FANOTIFY_MASK & FAN_ACCESS, 0);
        assert_eq!(MYTHODIKAL_FANOTIFY_MASK & FAN_OPEN, 0);
        assert_eq!(MYTHODIKAL_FANOTIFY_MASK & FAN_CLOSE_NOWRITE, 0);
    }
}
