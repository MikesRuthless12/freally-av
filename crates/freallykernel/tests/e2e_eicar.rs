...
//! Freally-private 256-byte sentinel that no upstream AV will block;
...
use freallykernel::db;
use freallykernel::detect::hash_blacklist::HashBlacklistDetector;
use freallykernel::detect::hash_set_file::write_sorted;
use freallykernel::detect::{
    DetectionPipeline, FileCtx, HashKind, PipelineOutcome, blake3_hex_to_bytes,
};
use freallykernel::findings::{self, FindingAction, FindingState};
use freallykernel::hasher::Hasher;
use freallykernel::history::{ScanTrigger, create_scan, record_finding};
use freallykernel::quarantine::{QuarantineKey, QuarantineVault};
use tempfile::tempdir;

/// 256-byte synthetic "malware" payload — a Freally-private sentinel
