...
pub const DEFAULT_CURATED_BIN_URL: &str =
    "https://github.com/MikesRuthless12/freally-av/releases/download/v0.7.14/abusech_sha256.bin";
/// SHA-256 checksum manifest for the asset above (sha256sum text format).
pub const DEFAULT_CURATED_SHA256_URL: &str = "https://github.com/MikesRuthless12/freally-av/releases/download/v0.7.14/abusech_sha256.bin.sha256";
