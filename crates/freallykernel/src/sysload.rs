...
impl SysLoad {
    ...
    pub fn external_cpu_percent(&self) -> f32 {
        (self.global_cpu_percent - self.freally_cpu_percent.min(100.0)).clamp(0.0, 100.0)
    }
}
...
mod tests {
    ...
    fn observe_returns_a_reading() {
        ...
        assert!(r.freally_cpu_percent >= 0.0);
    }
