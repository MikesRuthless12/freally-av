...
//!
//! ```ignore
//! use freallykernel::platform::mac::journal::{open, JournalEvent};
//! use std::path::Path;
//! use futures::StreamExt;
//!
//! # async fn demo() -> Result<(), freallykernel::platform::mac::journal::JournalError> {
...
// (`freallyd-macos` ESF NOTIFY-only daemon) will consume `subscribe()`.
