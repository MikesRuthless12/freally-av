...
//!
//! ```ignore
//! use freallykernel::platform::win::journal::{open, JournalEvent};
//! use std::path::Path;
//! use futures::StreamExt;
//!
//! # async fn demo() -> Result<(), freallykernel::platform::win::journal::JournalError> {
...
// consumed by Freally — Phase 5 wave 1 only uses `bootstrap()` for the
// fast walker. Phase 12 (`freallyd-windows` real-time service) will consume
