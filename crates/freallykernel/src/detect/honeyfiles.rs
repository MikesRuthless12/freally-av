...
//! `daemon/freallyd-linux/src/rules/honey.rs` (Linux today),
//! `daemon/freallyd-macos/src/rules/honey.rs` (Phase 9, TASK-161), and
//! `daemon/freallyd-windows/src/rules/honey.rs` (Phase 12, TASK-162).
//!
