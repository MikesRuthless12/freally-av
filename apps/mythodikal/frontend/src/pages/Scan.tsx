...
const INCLUDE_REGISTRY_KEY = "mythodikal.scan.includeRegistry";
const INCLUDE_PROCESSES_KEY = "mythodikal.scan.includeProcesses";
const INCLUDE_ARCHIVES_KEY = "mythodikal.scan.includeArchives";
const RUN_HEURISTICS_KEY = "mythodikal.scan.runHeuristics";
