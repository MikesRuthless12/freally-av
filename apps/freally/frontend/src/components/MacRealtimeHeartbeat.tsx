...
// launchd job writes `~/Library/Application Support/Freally/heartbeat.json`
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
              <span class="font-mono text-sm text-myth-text-hi">
                <Show
                  when={hb()}
                  fallback={"Freally real-time: heartbeat not started"}
                >
                  Freally real-time is alive: last beat {formatAge(hb()!.age_ms)}
                </Show>
              </span>
