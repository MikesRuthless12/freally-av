      ...
      <Show when={snap()}>
        ...
        <Show when={tab() === "updates"}>
          <section class="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <ChannelPane
              title="Engine"
              subtitle="The Freally app binary. Signed with ed25519; published to GitHub Releases."
              state={engineState()}
              busy={engineBusy()}
          ...
          <section class="space-y-3 rounded-md border border-myth-line bg-myth-bg-1 p-4 text-sm text-myth-text-md">
            ...
            <section class="space-y-2 rounded border border-myth-line/60 bg-myth-bg-0 p-3">
              ...
              {/* abuse.ch Auth-Key input intentionally hidden — the
                  ...
                  the day Freally is released open-source / non-
