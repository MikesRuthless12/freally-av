...
//   1. Welcome — what Freally is, what it isn't (no telemetry, no
      ...
      <div class="w-full max-w-xl rounded-lg border border-myth-line bg-myth-bg-1 p-8">
        ...
        <Show when={step() === 1}>
          <section class="space-y-4 text-sm text-myth-text-md">
            <p>
              Freally is an open-source anti-virus that runs entirely on
            ...
            <ul class="space-y-2 pl-4 [&_li]:list-disc">
              ...
              <li>
                ...
                Freally is a user-mode process — it does not require
        ...
        <Show when={step() === 2}>
          <section class="space-y-4 text-sm text-myth-text-md">
            <p>
              Freally ships with safe defaults; you can change any of
